...
# ─────────────────────────────────────────────────────────────────────────────
# Boss-Klassen  (Ersatz für boss_opp + punch_area in game_classes.py)
# ─────────────────────────────────────────────────────────────────────────────
...
class punch_area:
	...
	ALPHA  = 110  # Transparenz (0 = unsichtbar, 255 = untransparent)
	...
	def _get_color(self):
		...
		Inaktiv          → Weiß  (255, 255, 255, ALPHA)
		Aktiv, Beginn    → Weiß  (progress = 1.0)
		Aktiv, kurz vorm Einschlag → Rot (255, 0, 0, ALPHA)
		...
		progress = self.tick_count / self.max_ticks   # 1.0 → 0.0
		gb = int(255 * progress)
		return (255, gb, gb, self.ALPHA)
